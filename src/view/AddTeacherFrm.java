...
public class AddTeacherFrm extends JInternalFrame {
	...
	public AddTeacherFrm() {
		...
		resetButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {//重置按钮事件
				resetValue(ae);
			}
		});
	...
	protected void resetValue(ActionEvent ae) {//重置按钮事件的实现
	...
	protected void addTeacherAct(ActionEvent ae) {//添加老师事件的实现
		// TODO Auto-generated method stub
		String teacherName = teacherNameTextField.getText().toString();//获取老师相关信息
		...
		TeacherDao teacherDao = new TeacherDao();//数据库中进行操作
